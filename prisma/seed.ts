...
async function seedKatakana() {
  const katakana = [
    ...
    { character: "エ", romaji: "e", displayOrder: 4, mnemonicHint: "🏗️ Looks like a capital 'E' rotated — an elevator shaft with three floors." },
    ...
    { character: "ケ", romaji: "ke", displayOrder: 9, mnemonicHint: "🗝️ A key with an extra leg, angular version of け." },
    ...
    { character: "シ", romaji: "shi", displayOrder: 12, mnemonicHint: "🌧️ Three short strokes like falling rain — 'shi' for a light shower." },
    { character: "ス", romaji: "su", displayOrder: 13, mnemonicHint: "🤼 A person crouching in a swirl — 'su' for a sumo stance." },
    { character: "セ", romaji: "se", displayOrder: 14, mnemonicHint: "⚖️ A squared-off seesaw, angular version of せ." },
    ...
    { character: "ニ", romaji: "ni", displayOrder: 22, mnemonicHint: "2️⃣ Two horizontal strokes, like the kanji for 'two' — 'ni' for 'knee-two'." },
    { character: "ヌ", romaji: "nu", displayOrder: 23, mnemonicHint: "🍝 A noodle looping with a tail, angular version of ぬ." },
    { character: "ネ", romaji: "ne", displayOrder: 24, mnemonicHint: "⛩️ A shrine gate shape — 'ne' resembles ネ used in shrine names." },
    { character: "ノ", romaji: "no", displayOrder: 25, mnemonicHint: "🗡️ A single downward slash — the simplest katakana, just one stroke." },
    ...
    { character: "ヘ", romaji: "he", displayOrder: 29, mnemonicHint: "⛰️ A small peak or hill — same shape as へ in hiragana." },
    ...
    { character: "メ", romaji: "me", displayOrder: 34, mnemonicHint: "👁️ A crossed 'X' shape, angular version of め — 'me' means 'eye'." },
    ...
    { character: "ヲ", romaji: "wo", displayOrder: 45, mnemonicHint: "✍️ Rare — a hook with a flourish, only used as the particle 'wo/o'." },
    ...
    { character: "ゲ", romaji: "ge", displayOrder: 50, mnemonicHint: "🗝️✨ Same as ケ (ke) plus dakuten marks — buzzes into 'ge'." },
    ...
    { character: "ジ", romaji: "ji", displayOrder: 53, mnemonicHint: "🌧️✨ Same as シ (shi) plus dakuten marks — buzzes into 'ji'." },
    { character: "ズ", romaji: "zu", displayOrder: 54, mnemonicHint: "🤼✨ Same as ス (su) plus dakuten marks — buzzes into 'zu'." },
    { character: "ゼ", romaji: "ze", displayOrder: 55, mnemonicHint: "⚖️✨ Same as セ (se) plus dakuten marks — buzzes into 'ze'." },
    ...
    { character: "ベ", romaji: "be", displayOrder: 63, mnemonicHint: "⛰️✨ Same as ヘ (he) plus dakuten marks — buzzes into 'be'." },
    ...
    { character: "ペ", romaji: "pe", displayOrder: 68, mnemonicHint: "⛰️🔵 Same as ヘ (he) with a small circle (゜) — pops into 'pe'." },
